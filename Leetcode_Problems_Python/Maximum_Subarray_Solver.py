...
class MaximumSubarray_Solver(Solver):
    ...
    def solve(self, nums: List[int]) -> int:
        ...
        # Holding 2 arrays:
        # 1: Best sum till now
        # 2: Best sum of prev sub array: decide if to expand sub array: Start new sub array, if curr number better single than combined with prev. 
        # Otherwise expand with cur number.
